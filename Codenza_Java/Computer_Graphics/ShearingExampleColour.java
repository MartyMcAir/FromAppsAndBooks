...
*/
public class ShearingExampleColour extends Frame
{
    ...
    */
    ShearingExampleColour(int height)
    {
    ...
    public void paint(Graphics g)
    {
        ...
        */
        ...
        //Erzeuge und zeichne ein Rechteck, auf das eine Scherung angewendet
        //werden soll.
        Rectangle2D.Double rect = new Rectangle2D.Double(60,120,100,40);
        g2d.draw(rect);
        //Definiere eine Scherung.
        AffineTransform shear = new AffineTransform();
        shear.setToShear(1,0);
        //Zeichne das transformierte Rechteck in Rot.
    ...
    */
    ...
    {
        int height = 300;
        ShearingExampleColour f = new ShearingExampleColour(height);
        f.setTitle("Beispiel Scherung");
