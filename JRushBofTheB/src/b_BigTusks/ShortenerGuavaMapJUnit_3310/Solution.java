...
import b_BigTusks.UrlShortener_3310.strategy.OurHashMapStorageStrategy;
...
//        System.out.println("=========================================================================================");
    ...
    public static void testStrategy(StorageStrategy strategy, long elementsNumber) throws IOException, ClassNotFoundException {
        ...
        Helper.printMessage("из сета рандомныхстрок сет ключей заняло времени: " + String.valueOf(finish.getTime() - start.getTime()));
        ...
        Helper.printMessage("из сета ключей сет строк заняло времени:" + String.valueOf(new Date().getTime() - start.getTime()));
    ...
    public static void testStrategyMy(StorageStrategy strategy, long elementsNumber) {
        ...
        long start = date.getTime();
         Shortener shortener = new  Shortener(strategy);  // Создавать объект типа Shorten'er
