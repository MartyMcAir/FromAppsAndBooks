...
public class Snake {
    ...
    // возвращающий координату x нулевого элемента списка sections.
    // координату Х головы змеи
    public int getX() {
        return sections.get(0).getX();
    }

    // возвращающий координату y нулевого элемента списка sections.
    // координату Y головы змеи
    public int getY() {
