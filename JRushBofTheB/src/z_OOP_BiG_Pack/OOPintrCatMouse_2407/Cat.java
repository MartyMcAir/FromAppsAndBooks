...
public class Cat implements Pet {
     ...
     */
    // i - генерируется рандомное в методе convertPetToSayable() класса Util
    public Sayable toSayable(final int i) {
        final String nameF = name, ya = "я";
        ...
        class CatPet implements Sayable {
            ...
            public String say() {
                ...
                return nameF + " говорит м" + sb.toString() + "у!";
                // а все мыши по умолчанию пищат Override say() в классе Mouse()
            }
        }
        return new CatPet(); // возвращаем объект интерфейса Sayable
    }
}