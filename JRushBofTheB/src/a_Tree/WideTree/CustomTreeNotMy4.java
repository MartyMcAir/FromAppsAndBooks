...
// https://github.com/fighter-hd/JavaRushTasks/blob/master/4.JavaCollections/src/com/javarush/task/task20/task2028/CustomTree.java
public class CustomTreeNotMy4 extends AbstractList<String> implements Cloneable, Serializable {
    Map<Integer, List<Entry<String>>> tree = new TreeMap<>();
    Entry<String> root;
    private int size;

    public CustomTreeNotMy4() {
