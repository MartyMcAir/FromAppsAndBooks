...
// https://github.com/Sukora-Stas/JavaRushTasks/blob/master/4.JavaCollections/src/com/javarush/task/task20/task2028/CustomTree.java
public class CustomTreeNotMy3 extends AbstractList<String>
    ...
    public static void main(String[] args) {
        List<String> list = new CustomTreeNotMy3();
        for (int i = 1; i < 16; i++) {
            list.add(String.valueOf(i));
        }
        System.out.println("Expected 3, actual is " + ((CustomTreeNotMy3) list).getParent("8"));
        list.remove("5");
        System.out.println("Expected null, actual is " + ((CustomTreeNotMy3) list).getParent("11"));
    }
