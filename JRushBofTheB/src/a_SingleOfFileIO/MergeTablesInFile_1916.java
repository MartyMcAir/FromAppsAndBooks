...
//
//Требования:
//•	Класс Solution_3105 должен содержать класс LineItem.
//•	Класс Solution_3105 должен содержать enum Type.
//•	Класс Solution_3105 должен содержать публичное статическое поле lines типа List<LineItem>, которое сразу проинициализировано.
