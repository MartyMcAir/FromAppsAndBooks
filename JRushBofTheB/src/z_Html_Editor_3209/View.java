...
import z_Html_Editor_3209.listeners.FrameListener;
import z_Html_Editor_3209.listeners.TabbedPaneChangeListener;
import z_Html_Editor_3209.listeners.UndoListener;
...
//        return tabbedPane.getSelectedComponent() == tabbedPane.getComponents()[0]; // или так:
    ...
    // наследуется от интерфейса ActionListener и будет вызваться при выборе пунктов меню,
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (actionCommand) {
            ...
            case "Выход":
                ...
                break;
            case "О программе":
                showAbout(); // почему-то о программе поместили в View а не в Controller..
                break;
        }
    }
